...
function CustomerList() {
    ...
    return [
      ...
      columnHelper.accessor("status", {
        ...
        cell: ({ getValue }) => {
          ...
          return (
            <EnumBadge value={value} label={labelFor(CUSTOMER_STATUSES, value)} />
          );
        },
      }),
      columnHelper.accessor("phone", {
        id: "phone",
        header: translate("crm.customers.fields.phone", { ns: "app" }, "Phone"),
        enableSorting: false,
        cell: ({ getValue }) => getValue() || "—",
      }),
  ...
  }, [industryOptions, statusOptions, translate]);
