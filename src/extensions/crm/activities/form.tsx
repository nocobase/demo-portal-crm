...
const closeToFor = (presetCustomerId?: string) =>
  presetCustomerId ? getCustomerShowPath(presetCustomerId) : crmRoutes.activities;
...
export const ActivityCreate = ({ presetCustomerId }: ActivitySurfaceProps) => {
  ...
  return (
    <>
      <RouteDrawer
        title={translate("crm.activities.drawer.create.title", { ns: "app" }, "Log activity")}
        ...
        <RouteDrawerFooter className="flex-row justify-end">
          ...
          <Button type="submit" disabled={form.formState.isSubmitting}>
            {form.formState.isSubmitting
              ? translate("crm.activities.form.creating", { ns: "app" }, "Logging...")
              : translate("crm.activities.form.create", { ns: "app" }, "Log activity")}
          </Button>
        </RouteDrawerFooter>
      </form>
    </Form>
...
export const ActivityEdit = ({
  ...
  return (
    <>
      <RouteDrawer
        title={translate("crm.activities.drawer.edit.title", { ns: "app" }, "Edit activity")}
        closeTo={closeToFor(presetCustomerId)}
        closeLabel={translate("crm.common.close", { ns: "app" }, "Close")}
        beforeClose={beforeClose}
      >
